      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs font-mono text-white">{fmtMoney(data.gross || 0)}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-xs text-[#94A3B8]">Total Expenses</span>
            <span className="text-xs font-mono text-[#EF4444]">-{fmtMoney((data.gross || 0) * 0.4)}</span>
          </div>
          <div className="pt-2 border-t border-[#242A35] flex justify-between items-center">
            ...
            <span className="text-sm font-mono font-bold text-[#10B981]">{fmtMoney((data.gross || 0) * 0.6)}</span>
          </div>
        </div>
